...
enum MacI18n {
    ...
    private static let zh: [String: String] = [
        ...
        "serviceStarted": "服务已启动，绑定 %@:%d",
        "configServiceStarted": "配置服务已启动，绑定 127.0.0.1:%d",
        "configServiceStartFailed": "配置服务启动失败：127.0.0.1:8786-8795 均不可用",
    ...
    private static let en: [String: String] = [
        ...
        "serviceStarted": "Service started on %@:%d",
        "configServiceStarted": "Configuration service started on 127.0.0.1:%d",
        "configServiceStartFailed": "Configuration service failed to start: 127.0.0.1:8786-8795 are unavailable",
    ...
    private static let ja: [String: String] = [
        ...
        "serviceStarted": "サービスを開始しました：%@:%d",
        "configServiceStarted": "設定サービスを開始しました：127.0.0.1:%d",
        "configServiceStartFailed": "設定サービスを開始できません：127.0.0.1:8786-8795 は利用できません",
    ...
    private static let ko: [String: String] = [
        ...
        "serviceStarted": "서비스가 %@:%d에서 시작됨",
        "configServiceStarted": "설정 서비스가 127.0.0.1:%d에서 시작됨",
        "configServiceStartFailed": "설정 서비스 시작 실패: 127.0.0.1:8786-8795를 사용할 수 없음",
    ...
    private static let es: [String: String] = [
        ...
        "serviceStarted": "Servicio iniciado en %@:%d",
        "configServiceStarted": "Servicio de configuración iniciado en 127.0.0.1:%d",
        "configServiceStartFailed": "No se pudo iniciar configuración: 127.0.0.1:8786-8795 no están disponibles",
    ...
    private static let hi: [String: String] = [
        ...
        "serviceStarted": "सेवा %@:%d पर शुरू हुई",
        "configServiceStarted": "कॉन्फ़िगरेशन सेवा 127.0.0.1:%d पर शुरू हुई",
        "configServiceStartFailed": "कॉन्फ़िगरेशन सेवा शुरू नहीं हुई: 127.0.0.1:8786-8795 उपलब्ध नहीं",
    ...
    private static let ar: [String: String] = [
        ...
        "serviceStarted": "بدأت الخدمة على %@:%d",
        "configServiceStarted": "بدأت خدمة الإعداد على 127.0.0.1:%d",
        "configServiceStartFailed": "تعذر بدء خدمة الإعداد: 127.0.0.1:8786-8795 غير متاحة",
