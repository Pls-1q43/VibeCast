...
| 本地配置 | 菜单栏打开配置页，选择 Bundle ID、聚焦方式、写入方式和发送方式 |
...
2. 菜单栏点击“打开配置页面…”，为目标应用配置 Bundle ID、聚焦策略和发送方式。
...
仍建议在正式日常使用前，针对自己的目标应用版本执行配置页里的“测试目标”，尤其是 Notion、Electron 应用和自定义快捷键场景。
